...
//---------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	// departamentos na observableList, que será associado ao tableView,e ai entao
...
//---------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	public void onDataChanged() {
		updateTableView();
		// quando receber a notificação que os dados foram alterados, irá atualizar os
		// dados da tabela
...
//---------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	private void removeEntity(Department obj) {		
		Optional<ButtonType> resultado = Alerts.Confirmacao("Confirmação", "Deseja realmente Remover ?");
		...
		if(resultado.get() == ButtonType.OK) {
			...
			updateTableView();
				...
				Alerts.showAlert("Erro Remoção do Objeto", null, e.getMessage(), AlertType.ERROR);
			}
